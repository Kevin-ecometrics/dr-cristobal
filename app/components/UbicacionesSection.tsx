...
const UbicacionesSection: React.FC = () => {
  return (
    <section
      id="ubicaciones"
      className="py-20 px-6 bg-linear-to-b from-white to-gray-50"
    >
      <div className="container mx-auto max-w-7xl">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-light text-gray-700 mb-4">
            Nuestras{" "}
            <span className="text-main font-semibold">Ubicaciones</span>
          </h2>
          <div className="w-32 h-1 bg-linear-to-r from-main via-main to-main mx-auto rounded-full"></div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-4 bg-gray-50 p-5 rounded-xl">
                <a
                  ...
                  className="flex items-start gap-3 text-gray-700 hover:text-main transition-colors group"
                >
                  <FiMapPin className="w-5 h-5 text-main shrink-0 mt-1 group-hover:scale-110 transition-transform" />
                  <span className="font-medium">
                    Zaragoza #377, Centro, Tecomán, Col.
                  </span>
                </a>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <a
                      href="tel:3123122121"
                      className="block text-gray-700 hover:text-main transition-colors font-medium"
                    >
                      Tels. 312 312 2121
                    </a>
                    <a
                      href="tel:3121320435"
                      className="block text-sm text-main hover:text-main transition-colors mt-1 font-semibold"
                    >
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-4 bg-gray-50 p-5 rounded-xl">
                ...
                >
                  <FiMapPin className="w-5 h-5 text-main shrink-0 mt-1 group-hover:scale-110 transition-transform" />
                  <span className="font-medium">
                    18 de Marzo #113, Centro, Tecomán, Col.
                  </span>
                </a>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <a
                    href="tel:3133242688"
                    className="text-gray-700 hover:text-main transition-colors font-medium"
                  >
                    Tel. 313 324 2688
                  </a>
                </div>
